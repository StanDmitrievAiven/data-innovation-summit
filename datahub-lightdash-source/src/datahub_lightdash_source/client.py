...
from datahub_lightdash_source.models import (
    LightdashChart,
...
class LightdashClient:
    ...
    def health(self) -> dict[str, Any]:
        ...
        resp = self._session.get(url, timeout=self.timeout_seconds, verify=self.verify_ssl)
    ...
    def get_project(self, project_uuid: str) -> LightdashProject:
        return LightdashProject.model_validate(self._get(f"/api/v1/projects/{project_uuid}"))
    ...
    def get_dashboard(self, dashboard_uuid: str) -> LightdashDashboard:
        return LightdashDashboard.model_validate(self._get(f"/api/v1/dashboards/{dashboard_uuid}"))
