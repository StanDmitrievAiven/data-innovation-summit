...
class LightdashSourceConfig(
    ...
    include_organization_container: bool = Field(
        ...
        description=(
            ...
            "and parent each project under it. Most demos leave this off — the "
            "Organization is implicit."
        ),
    )
    ...
    warehouse_platform: str | None = Field(
        default=None,
        description=(
    ...
    warehouse_platform_instance: str | None = Field(
        default=None,
        description=(
    ...
    warehouse_database_override: str | None = Field(
        default=None,
        description=(
    ...
    def resolve_warehouse_platform(self, warehouse_type: str | None) -> tuple[str, bool]:
